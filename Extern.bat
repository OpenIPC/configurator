...
if "%1" == "pixelpilot" (
	...
	echo y | pscp -scp -pw %3 etc/default/pixelpilot root@%2:/etc/default/
	echo y | pscp -scp -pw %3 etc/default/pixelpilot root@%2:/usr/local/etc/pixelpilot/
	echo y | pscp -scp -pw %3 etc/pixelpilot/* root@%2:/usr/local/etc/pixelpilot/
	plink -ssh root@%2 -pw %3 reboot 
)
